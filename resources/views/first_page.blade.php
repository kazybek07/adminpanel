...
<body translate="no" style="background: #e9ecef;">
    <div class="jumbotron text-center">
        ...
        <p class="lead">
            <strong style="display:block;">Thanks for purchase Shinewash</strong>
            <br>
        ...
        <hr>
        <p class="lead">
            <a class="btn btn-primary btn-sm" href="{{ url('/license/install') }}" role="button">Installer</a>
        </p>
    </div>
