                            ...
                            <div class="tab-pane" id="link111">
                                <form action="{{ url('admin/update_payment_setting') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('flutterwave_public_key') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('paystack_public_key') is-invalid @enderror"
