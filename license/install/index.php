    ...
    <div class="container">
        <div class="section">
            <div class="column is-6 is-offset-3">
                <center>
                    <h1 class="title" style="padding-top: 20px">Shinewash</h1><br>
                </center>
                <div class="box">
                    <?php
                    switch ($step) {
                            ...
                            <?php
                                    if ($_POST && isset($_POST["lcscs"])) {
                                        ...
                                        <form action="index.php?step=1" method="POST">
                                            ...
                                            $templine = '';
                                            $filename = '../includes/db_shinewash.sql';
                                            $lines = file($filename);
                            ...
                            ?>
                                ...
                                <form action="#" id="admin-detal-form" method="POST">
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input class="input" type="email" value="adminshinewash@gmail.com" id="email" placeholder="Enter your admin email" name="email" required readonly>
